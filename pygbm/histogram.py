...
def _build_histogram(n_bins, sample_indices, binned_feature, ordered_gradients,
    ...
    unrolled_upper = (n_node_samples // 8) * 8
    ...
    for i in range(0, unrolled_upper, 8):
        ...
        histogram[bin_4]['sum_gradients'] += ordered_gradients[i + 4]
        histogram[bin_5]['sum_gradients'] += ordered_gradients[i + 5]
        histogram[bin_6]['sum_gradients'] += ordered_gradients[i + 6]
        histogram[bin_7]['sum_gradients'] += ordered_gradients[i + 7]
        ...
        histogram[bin_4]['sum_hessians'] += ordered_hessians[i + 4]
        histogram[bin_5]['sum_hessians'] += ordered_hessians[i + 5]
        histogram[bin_6]['sum_hessians'] += ordered_hessians[i + 6]
        histogram[bin_7]['sum_hessians'] += ordered_hessians[i + 7]

        histogram[bin_0]['count'] += 1
        histogram[bin_1]['count'] += 1
        histogram[bin_2]['count'] += 1
        histogram[bin_3]['count'] += 1
        histogram[bin_4]['count'] += 1
        histogram[bin_5]['count'] += 1
        histogram[bin_6]['count'] += 1
        histogram[bin_7]['count'] += 1
...
def _build_histogram_root_no_hessian(n_bins, binned_feature, all_gradients):
    ...
    for i in range(0, unrolled_upper, 8):
        ...
        histogram[bin_4]['sum_gradients'] += all_gradients[i + 4]
        histogram[bin_5]['sum_gradients'] += all_gradients[i + 5]
        histogram[bin_6]['sum_gradients'] += all_gradients[i + 6]
        histogram[bin_7]['sum_gradients'] += all_gradients[i + 7]
...
def _build_histogram_root(n_bins, binned_feature, all_gradients,
    ...
    for i in range(0, unrolled_upper, 8):
        ...
        histogram[bin_4]['sum_hessians'] += all_hessians[i + 4]
        histogram[bin_5]['sum_hessians'] += all_hessians[i + 5]
        histogram[bin_6]['sum_hessians'] += all_hessians[i + 6]
        histogram[bin_7]['sum_hessians'] += all_hessians[i + 7]
